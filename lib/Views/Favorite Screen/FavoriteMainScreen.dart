...
class _FavoriteMainScreenState extends State<FavoriteMainScreen> {
  ...
  accessApi(BuildContext context) async {
   ...
   await apiConnection1.favoriteAllDataAPI();
          ...
          : ListView.builder(
             ...
             // shrinkWrap: true,
              ...
              itemBuilder: (context, index) {
                if (favoriteProvider
                    .favoriteData.data[index].productDetails.imageUrl.isEmpty) {
                  return Container();
                } else {
                  return InkWell(
                    hoverColor: Colors.transparent,
                                  ...
                                  child: Column(
                                    children: [
                                      Align(
                                        ...
                                        child: favoriteProvider.favoriteData.data[index].id != ''
                                            ? InkWell(
                                                onTap: () async {
                                                 ...
                                                 //   accessApi(context);
                                                    favoriteProvider.favoriteAllDataAPI();
