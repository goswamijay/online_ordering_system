...
class Authentication extends ChangeNotifier{
  ...
  Future<void> signUpUser( String email, String password, String name, String mobileNo) async {
    try {
      var uri = Uri.parse('https://shopping-app-backend-t4ay.onrender.com/user/registerUser');
      ...
      if (response.statusCode == 201) {
        ...
        await prefs.setStringList(
          'signUpData', signUpData.map((e) => e.toString()).toList(),
        );
  ...
  Future<void> otpVerificationMain( String userId, String otp) async {
    try {
      var uri = Uri.parse('https://shopping-app-backend-t4ay.onrender.com/user/verifyOtpOnRegister');
      var response = await http.post(uri, headers: {
        'Content-type': 'application/json',
        "Accept": "application/json",
        "Access-Control_Allow_Origin": "*"
  ...
  static Future<List<SignupModelClass>> otpVerificationMain1(
  ...
  Future<void> loginUser(String email, String password) async {
    try {
      var uri = Uri.parse('https://shopping-app-backend-t4ay.onrender.com/user/login');
      var response = await http.post(uri, headers: {
        'Content-type': 'application/json',
        "Accept": "application/json",
        "Access-Control_Allow_Origin": "*"
      ...
      if (response.statusCode == 200) {
        ...
        final prefs = await SharedPreferences.getInstance();
        await prefs.setStringList(
          'loginData', loginData.map((e) => e.toString()).toList(),
        );
        await prefs.setString('login1', loginData[0].status);
        notifyListeners();
  ...
  static Future<List<ResetPasswordOtpModelClass>> resetPassword(String email) async {
  ...
  static Future<List<ResetPasswordOtpModelClass1>> resetPassword2(String jwtToken,String password) async {
