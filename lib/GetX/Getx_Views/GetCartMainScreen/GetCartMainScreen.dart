                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                Text(
                                  "Total Items (${cartController.getCartAddItemModelClass.data.length}) :-",
                ...
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        left: 12.0, right: 12.0, bottom: 6.0, top: 6.0),                    child: InkWell(
                      onTap: () {
                        cartController.getCartAddItemModelClass.data.isNotEmpty
                            ? Get.defaultDialog(
