...
import 'Bloc/BlocAccountResetPasswordBloc.dart';
import 'Bloc/BlocAccountResetPasswordEvent.dart';
import 'Bloc/BlocAccountResetPasswordState.dart';
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    BlocConsumer<BlocAccountResetPasswordBloc,
                        ...
                        return InkWell(
                          onTap: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              BlocProvider.of<BlocAccountResetPasswordBloc>(
                                      context)
                                  .add(BlocAccountPasswordChangeEvent(
                      ...
                      listener: (listener, state) {
                        if (state
                            is BlocAccountResetPasswordChangeSuccessfullyState) {
                          Future.delayed(const Duration(seconds: 0), () {
                            ...
                            is BlocAccountResetPasswordChangeFailState) {
                          showDialog(
                              context: context,
                              builder: (context) {
                                return AlertDialog(
