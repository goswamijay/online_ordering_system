...
import 'Bloc/BlocOrderPlaceMainBloc.dart';
import 'Bloc/BlocOrderPlaceMainEvent.dart';
import 'Bloc/BlocOrderPlaceMainState.dart';
...
class _BlocOrderPlaceMainScreenState extends State<BlocOrderPlaceMainScreen> {
  ...
  Widget build(BuildContext context) {
    BlocOrderPlaceMainBloc placeOrderController =
        BlocProvider.of<BlocOrderPlaceMainBloc>(context);
    BlocProvider.of<BlocOrderPlaceMainBloc>(context)
        .add(BlocPlaceOrderAllGetItemEvent());
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: BlocConsumer<BlocOrderPlaceMainBloc, BlocOrderPlaceMainState>(
  ...
  Widget fullList1(BuildContext context) {
    BlocOrderPlaceMainBloc confirmController =
        BlocProvider.of<BlocOrderPlaceMainBloc>(context);
    Size size = MediaQuery.of(context).size;

    return confirmController.blocPlaceOrderModelClass.data.isEmpty
        ? Center(
            child: Column(
        ...
        : BlocConsumer<BlocOrderPlaceMainBloc, BlocOrderPlaceMainState>(
            builder: (builder, state) {
            return ListView.builder(
                itemCount:
                    confirmController.blocPlaceOrderModelClass.data.length,
                                  ...
                                  children: [
                                    Align(
                                        ...
                                        child: AutoSizeText(
                                          ...
                                          "${'Order Place Date'}:- ${confirmController.blocPlaceOrderModelClass.data[index].updatedAt}",
                                        ...
                                        Expanded(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Align(
                                              ...
                                              child: Text(
                                                '\$${confirmController.blocPlaceOrderModelClass.data[index].price}',
                                                style: const TextStyle(
                                        ...
                                        Expanded(
                                          child: SizedBox(
                                            ...
                                            child: Align(
                                              alignment: Alignment.topLeft,
                                              child: AutoSizeText(
                                                '${'Total Items added'}:-${confirmController.blocPlaceOrderModelClass.data[index].quantity}',
                                                style: const TextStyle(
                                                    fontSize: 18),
                                                maxLines: 1,
                                              ),
